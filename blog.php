    ...
    <section class="blog" id="blog">
        <div class="container">
          ...
          <ul class="blog-list has-scrollbar">
            ...
            <li onclick="window.location.href='enlightenio.liveblog365.com';">
              <div class="blog-card">

                <figure class="card-banner">
                  <img src="./assets/images/property-1.jpg" alt="The Most Inspiring Interior Design Of 2021" class="w-100">
                </figure>
            ...
            <li>
              <div class="blog-card">
                <figure class="card-banner">
                  <img src="./assets/images/property-2.jpg" alt="Recent Commercial Real Estate Transactions" class="w-100">
                </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/property-4.png" alt="Renovating a Living Room? Experts Share Their Secrets"
                    class="w-100">
                </figure>
    ...
    <section class="blog-2">
        <div class="blog-box">
            ...
            <div class="blog-details">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius magni est ad rem maiores!</p>
        ...
        <div class="blog-box">
            <div class="blog-img">
                <img src="./assets/images/about-banner-2.jpg" alt="">
            </div>
            <div class="blog-details">
                <h4>Lorem ipsum dolor sit amet.</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius magni est ad rem maiores!</p>
